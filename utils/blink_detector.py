...
>>>>>>> dc31fdf (Refactored blink detection pipeline: fixed baseline contamination, added continuous recalibration, improved adaptive EAR threshold logic, and enhanced engagement scoring accuracy with multi-window analysis)
import cv2
import time
import numpy as np
